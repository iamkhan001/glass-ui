    ...
    <Card className="h-100">
          <SuiBox pt={2} px={2}>
            <SuiBox display="flex" justifyContent="space-between" alignItems="center">
              ...
              <SuiTypography mt={2} variant="h6" fontWeight="caption" textTransform="capitalize">
...
{/*  */}
            ...
            <SuiTypography align='justify' fontWeight='light' variant='h6' >
              <p class="info">
                  These Terms of Use constitute a legally binding agreement made between you, whether personally or on behalf of an entity (“you”) and MIROBOTIC ("Company," “we," “us," or “our”), concerning your access to and use of the glass.mirobotic.tech website as well as any other media form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the “Site”). We are registered in Singapore and have our registered office at 67 Ayer Rajah Crescent, #07-01 , Singapore, Singapore 139950. You agree that by accessing the Site, you have read, understood, and agreed to be bound by all of these Terms of Use. IF YOU DO NOT AGREE WITH ALL OF THESE TERMS OF USE, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SITE AND YOU MUST DISCONTINUE USE IMMEDIATELY.
...
{/*  */}
            ...
            <SuiTypography align='justify' fontWeight='light' variant='h6' >
              <p  class="info">
                  These Terms shall be governed by and defined following the laws of Singapore. MIROBOTIC and yourself irrevocably consent that the courts of Singapore shall have exclusive jurisdiction to resolve any dispute which may arise in connection with these terms.
              </p>
            </SuiTypography>
{/*  */}
            <SuiTypography mt={2} variant="h4" fontWeight="medium" textTransform="capitalize">
