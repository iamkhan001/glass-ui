    ...
    <Card className="h-100">
          <SuiBox py={2} px={4}>
            <SuiTypography  align='justify' fontWeight='light' variant='h6' >
              <p>At ZOOMABLE accessible from <a href="https://zoomable.tech">zoomable.tech</a>, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by zoomable.tech and how we use it.</p>
